...
bool flag[SIZE_N+5];
int primes[SIZE_P+5];
int store_primes[100],      //Storing Primes
    freq_primes[100],       //Storing frequency of primes
    store_divisor[10000],   //Storing the divisors generated
    Total_Prime,
    ans;
int seive(){
    int i,j,total=0,val;
